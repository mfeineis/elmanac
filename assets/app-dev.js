...
var _mfeineis$elmanach$App$ViewOptions = function (a) {
	return {injectStyles: a};
};
var _mfeineis$elmanach$App$Model = F6(
	function (a, b, c, d, e, f) {
		return {autoState: a, howManyToShow: b, query: c, people: d, selectedPerson: e, showMenu: f};
	});
var _mfeineis$elmanach$App$Person = function (a) {
	return {name: a};
};
var _mfeineis$elmanach$App$NoOp = {ctor: 'NoOp'};
var _mfeineis$elmanach$App$OnFocus = {ctor: 'OnFocus'};
var _mfeineis$elmanach$App$PreviewPerson = function (a) {
	return {ctor: 'PreviewPerson', _0: a};
};
var _mfeineis$elmanach$App$SelectPersonMouse = function (a) {
	return {ctor: 'SelectPersonMouse', _0: a};
};
var _mfeineis$elmanach$App$SelectPersonKeyboard = function (a) {
	return {ctor: 'SelectPersonKeyboard', _0: a};
};
var _mfeineis$elmanach$App$HandleEscape = {ctor: 'HandleEscape'};
var _mfeineis$elmanach$App$Reset = {ctor: 'Reset'};
var _mfeineis$elmanach$App$Wrap = function (a) {
	return {ctor: 'Wrap', _0: a};
};
var _mfeineis$elmanach$App$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _mfeineis$elmanach$App$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};

var _mfeineis$elmanach$Update$resetMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{autoState: _thebritican$elm_autocomplete$Autocomplete$empty, showMenu: false});
};
var _mfeineis$elmanach$Update$getPersonAtId = F2(
	function (people, id) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_mfeineis$elmanach$App$Person(''),
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (x) {
						return _elm_lang$core$Native_Utils.eq(x.name, id);
					},
					people)));
	});
var _mfeineis$elmanach$Update$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				query: function (_) {
					...
					A2(_mfeineis$elmanach$Update$getPersonAtId, model.people, id)),
				selectedPerson: _elm_lang$core$Maybe$Just(
					A2(_mfeineis$elmanach$Update$getPersonAtId, model.people, id))
			});
	});
var _mfeineis$elmanach$Update$removeSelection = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedPerson: _elm_lang$core$Maybe$Nothing});
};
var _mfeineis$elmanach$Update$resetInput = function (model) {
	return _mfeineis$elmanach$Update$resetMenu(
		_mfeineis$elmanach$Update$removeSelection(
			_elm_lang$core$Native_Utils.update(
				model,
				{query: ''})));
};
var _mfeineis$elmanach$Update$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		toId: function (_) {
			return _.name;
		},
		onKeyDown: F2(
			function (code, maybeId) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(_elm_lang$core$Maybe$map, _mfeineis$elmanach$App$PreviewPerson, maybeId) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(_elm_lang$core$Maybe$map, _mfeineis$elmanach$App$SelectPersonKeyboard, maybeId) : _elm_lang$core$Maybe$Just(_mfeineis$elmanach$App$Reset));
			}),
		onTooLow: _elm_lang$core$Maybe$Just(
			_mfeineis$elmanach$App$Wrap(false)),
		onTooHigh: _elm_lang$core$Maybe$Just(
			_mfeineis$elmanach$App$Wrap(true)),
		onMouseEnter: function (id) {
			return _elm_lang$core$Maybe$Just(
				_mfeineis$elmanach$App$PreviewPerson(id));
		},
		...
		onMouseClick: function (id) {
			return _elm_lang$core$Maybe$Just(
				_mfeineis$elmanach$App$SelectPersonMouse(id));
		},
		separateSelections: false
	});
var _mfeineis$elmanach$Update$acceptablePeople = F2(
...
var _mfeineis$elmanach$Update$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p1 = msg;
			switch (_p1.ctor) {
				case 'SetQuery':
					...
					var showMenu = function (_p2) {
						...
						A2(_mfeineis$elmanach$Update$acceptablePeople, _p3, model.people));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{query: _p3, showMenu: showMenu, selectedPerson: _elm_lang$core$Maybe$Nothing}),
						{ctor: '[]'});
				case 'SetAutoState':
					var people = A2(_mfeineis$elmanach$Update$acceptablePeople, model.query, model.people);
					var _p4 = A5(_thebritican$elm_autocomplete$Autocomplete$update, _mfeineis$elmanach$Update$updateConfig, _p1._0, model.howManyToShow, model.autoState, people);
					var newState = _p4._0;
					var maybeMsg = _p4._1;
				...
				case 'HandleEscape':
					var people = A2(_mfeineis$elmanach$Update$acceptablePeople, model.query, model.people);
					var validOptions = !_elm_lang$core$List$isEmpty(people);
					var handleEscape = validOptions ? _mfeineis$elmanach$Update$resetMenu(
						_mfeineis$elmanach$Update$removeSelection(model)) : _mfeineis$elmanach$Update$resetInput(model);
					var escapedModel = function () {
						var _p6 = model.selectedPerson;
						if (_p6.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.query, _p6._0.name) ? _mfeineis$elmanach$Update$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
				...
				case 'Wrap':
					...
					if (_p7.ctor === 'Just') {
						var _v6 = _mfeineis$elmanach$App$Reset,
							_v7 = model;
						msg = _v6;
						model = _v7;
						continue update;
						...
						return _p1._0 ? A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									autoState: A4(_thebritican$elm_autocomplete$Autocomplete$resetToLastItem, _mfeineis$elmanach$Update$updateConfig, people, model.howManyToShow, model.autoState),
									selectedPerson: _elm_lang$core$List$head(
										_elm_lang$core$List$reverse(
											A2(
												_elm_lang$core$List$take,
												model.howManyToShow,
												A2(_mfeineis$elmanach$Update$acceptablePeople, model.query, model.people))))
								}),
							{ctor: '[]'}) : A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									autoState: A4(
										...
										_mfeineis$elmanach$Update$updateConfig,
										A2(_mfeineis$elmanach$Update$acceptablePeople, model.query, model.people),
										model.howManyToShow,
										model.autoState),
									selectedPerson: _elm_lang$core$List$head(
				...
				case 'Reset':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								autoState: A2(_thebritican$elm_autocomplete$Autocomplete$reset, _mfeineis$elmanach$Update$updateConfig, model.autoState),
								selectedPerson: _elm_lang$core$Maybe$Nothing
							}),
						{ctor: '[]'});
				case 'SelectPersonKeyboard':
					var newModel = _mfeineis$elmanach$Update$resetMenu(
						A2(_mfeineis$elmanach$Update$setQuery, model, _p1._0));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{ctor: '[]'});
				case 'SelectPersonMouse':
					...
					return {
						...
						_1: A2(
							...
							function (_p8) {
								return _mfeineis$elmanach$App$NoOp;
							},
				...
				case 'PreviewPerson':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								selectedPerson: _elm_lang$core$Maybe$Just(
									A2(_mfeineis$elmanach$Update$getPersonAtId, model.people, _p1._0))
							}),
						{ctor: '[]'});
				case 'OnFocus':
					return A2(
...
var _mfeineis$elmanach$Styles$appNamespace = 'ea-';
var _mfeineis$elmanach$Styles$helpers = function () {
	var _p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_mfeineis$elmanach$Styles$appNamespace);
	var id = _p0.id;
	var $class = _p0.$class;
	var classList = _p0.classList;
	return {cssId: id, cssClass: $class, cssClassList: classList};
}();
var _mfeineis$elmanach$Styles$AutocompleteItemKeySelected = {ctor: 'AutocompleteItemKeySelected'};
var _mfeineis$elmanach$Styles$AutocompleteItem = {ctor: 'AutocompleteItem'};
var _mfeineis$elmanach$Styles$AutocompleteList = {ctor: 'AutocompleteList'};
var _mfeineis$elmanach$Styles$AutocompleteMenu = {ctor: 'AutocompleteMenu'};
var _mfeineis$elmanach$Styles$AutocompleteInput = {ctor: 'AutocompleteInput'};
var _mfeineis$elmanach$Styles$AutocompleteContainer = {ctor: 'AutocompleteContainer'};
var _mfeineis$elmanach$Styles$PresidentInput = {ctor: 'PresidentInput'};
var _mfeineis$elmanach$Styles$css = function (_p1) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _mfeineis$elmanach$Styles$appNamespace, _p1));
}(
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				_mfeineis$elmanach$Styles$PresidentInput,
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_mfeineis$elmanach$Styles$AutocompleteContainer,
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_mfeineis$elmanach$Styles$AutocompleteInput,
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_mfeineis$elmanach$Styles$AutocompleteMenu,
							{
								ctor: '::',
								_0: A3(
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_mfeineis$elmanach$Styles$AutocompleteList,
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_mfeineis$elmanach$Styles$AutocompleteItem,
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_mfeineis$elmanach$Styles$AutocompleteItemKeySelected,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$color(
												_rtfeldman$elm_css$Css$hex('f60')),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _mfeineis$elmanach$Util_ops = _mfeineis$elmanach$Util_ops || {};
_mfeineis$elmanach$Util_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});

var _mfeineis$elmanach$View$acceptablePeople = F2(
	function (query, people) {
		return A3(
			_NoRedInk$elm_simple_fuzzy$Simple_Fuzzy$filter,
			function (_) {
...
var _mfeineis$elmanach$View$fromResult = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
...
var _mfeineis$elmanach$View$decoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	_mfeineis$elmanach$View$fromResult,
	A2(
		_elm_lang$core$Json_Decode$map,
		function (code) {
			return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(_mfeineis$elmanach$App$NoOp) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(_mfeineis$elmanach$App$HandleEscape) : _elm_lang$core$Result$Err('not handling that key'));
		},
		_elm_lang$html$Html_Events$keyCode));
var _mfeineis$elmanach$View$eventOptions = {preventDefault: true, stopPropagation: false};
var _mfeineis$elmanach$View$_p1 = _mfeineis$elmanach$Styles$helpers;
var _mfeineis$elmanach$View$cssId = _mfeineis$elmanach$View$_p1.cssId;
var _mfeineis$elmanach$View$cssClass = _mfeineis$elmanach$View$_p1.cssClass;
var _mfeineis$elmanach$View$cssClassList = _mfeineis$elmanach$View$_p1.cssClassList;
var _mfeineis$elmanach$View$viewConfig = function () {
	var customizedLi = F3(
		function (keySelected, mouseSelected, person) {
			return {
				attributes: {
					ctor: '::',
					_0: _mfeineis$elmanach$View$cssClassList(
						{
							ctor: '::',
							_0: A2(_mfeineis$elmanach$Util_ops['=>'], _mfeineis$elmanach$Styles$AutocompleteItem, true),
							_1: {
								ctor: '::',
								_0: A2(_mfeineis$elmanach$Util_ops['=>'], _mfeineis$elmanach$Styles$AutocompleteItemKeySelected, keySelected || mouseSelected),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
	...
	return _thebritican$elm_autocomplete$Autocomplete$viewConfig(
		{
			...
			ul: {
				ctor: '::',
				_0: _mfeineis$elmanach$View$cssClass(
					{
						ctor: '::',
						_0: _mfeineis$elmanach$Styles$AutocompleteList,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _mfeineis$elmanach$View$viewMenu = function (model) {
	var people = A2(_mfeineis$elmanach$View$acceptablePeople, model.query, model.people);
	var view = A4(_thebritican$elm_autocomplete$Autocomplete$view, _mfeineis$elmanach$View$viewConfig, model.howManyToShow, model.autoState, people);
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _mfeineis$elmanach$View$cssClass(
				{
					ctor: '::',
					_0: _mfeineis$elmanach$Styles$AutocompleteMenu,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html$map, _mfeineis$elmanach$App$SetAutoState, view),
			_1: {ctor: '[]'}
		});
};
var _mfeineis$elmanach$View$view = F2(
	function (options, model) {
		var activeDescendant = function (attributes) {
			...
			if (_p2.ctor === 'Just') {
				return {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-activedescendant', _p2._0.name),
					_1: attributes
				};
			} else {
				return attributes;
		...
		var menu = model.showMenu ? {
			ctor: '::',
			_0: _mfeineis$elmanach$View$viewMenu(model),
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
		var menuWithStyle = options.injectStyles ? A2(
			_elm_lang$core$Basics_ops['++'],
			menu,
			{
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('../../assets/style.css'),
						_1: {
							ctor: '::',
			...
			_elm_lang$core$List$append,
			{
				...
				_0: A2(
					...
					activeDescendant(
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_mfeineis$elmanach$App$SetQuery),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onFocus(_mfeineis$elmanach$App$OnFocus),
								_1: {
									ctor: '::',
									_0: A3(_elm_lang$html$Html_Events$onWithOptions, 'keydown', _mfeineis$elmanach$View$eventOptions, _mfeineis$elmanach$View$decoder),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(query),
										_1: {
											ctor: '::',
											_0: _mfeineis$elmanach$View$cssId(_mfeineis$elmanach$Styles$PresidentInput),
											_1: {
												ctor: '::',
												_0: _mfeineis$elmanach$View$cssClass(
													{
														ctor: '::',
														_0: _mfeineis$elmanach$Styles$AutocompleteInput,
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _mfeineis$elmanach$View$cssClass(
					{
						ctor: '::',
						_0: _mfeineis$elmanach$Styles$AutocompleteContainer,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _mfeineis$elmanach$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Platform_Sub$map, _mfeineis$elmanach$App$SetAutoState, _thebritican$elm_autocomplete$Autocomplete$subscription);
};
...
var _mfeineis$elmanach$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _mfeineis$elmanach$Main$init,
		subscriptions: _mfeineis$elmanach$Main$subscriptions,
		update: _mfeineis$elmanach$Update$update,
		view: _mfeineis$elmanach$View$view(
			{injectStyles: false})
	})(
	_elm_lang$core$Json_Decode$succeed(
		{}));
