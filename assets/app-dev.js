								...
								_1: {
									...
									_1: {
										...
										_0: A4(
											...
											_rtfeldman$elm_css$Css$zero,
											_rtfeldman$elm_css$Css$px(40 + 10)),
										_1: {
											ctor: '::',
						...
						_0: _rtfeldman$elm_css$Css$backgroundImage(
							A3(
								...
								_rtfeldman$elm_css$Css$stop(
									_rtfeldman$elm_css$Css$hex('f7f7f7')),
								A2(
				...
				_0: _mfeineis$elmanac$Styled$styles(
					{
						...
						_0: _rtfeldman$elm_css$Css$backgroundImage(
							A4(
								...
								_rtfeldman$elm_css$Css$toBottomRight,
								_rtfeldman$elm_css$Css$stop(
									_rtfeldman$elm_css$Css$hex('60b5cc')),
								_rtfeldman$elm_css$Css$stop(
									_rtfeldman$elm_css$Css$hex('7fd13b')),
								{ctor: '[]'})),
						_1: {
							ctor: '::',
							_0: A3(
								...
								_0: _mfeineis$elmanac$Styled$styles(
									{
										...
										_1: {
											...
											_0: A4(
												...
												_rtfeldman$elm_css$Css$hex('bbbbbb')),
											_1: {
												ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Css$color(
											_rtfeldman$elm_css$Css$hex('888888')),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$marginTop(
												_rtfeldman$elm_css$Css$px(-1)),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('I am an Elm developer'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Enabled Code Search'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Include Doc comments'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Include type signatures'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Include migration topics'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('I am new to web development'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Prioritize basic constructs'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Show \"Getting Started\" content'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('I am a manager or CTO'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Include Roadmap'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Include non-technical sources'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Your settings will be safed in `localStorage`.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Save Settings'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_0: A3(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Blubb'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Plisch'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Float'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Complex'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Just something'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
